    ...
    <header className="h-16 border-b border-white/5 flex items-center justify-between px-8 gap-4">
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          <span className="absolute top-1 right-1 w-4 h-4 bg-orange-primary text-[10px] font-bold text-white rounded-full flex items-center justify-center border-2 border-navy-950">
            4
          </span>
        </button>
